  ...
  learnings: (
    ...
    >
      ...
      <path
        ...
        fill="#1E1B4B"
      />
      <circle cx="34" cy="34" r="2.5" fill="#F8FAFC" />
      <path d="M34 54V14" stroke="#F8FAFC" strokeWidth="2" />
      <path d="M51.3205 24L16.6795 44" stroke="#F8FAFC" strokeWidth="2" />
      <path d="M51.3205 44L16.6795 24" stroke="#F8FAFC" strokeWidth="2" />
    </svg>
  ),
};
