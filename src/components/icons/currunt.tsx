...
export function Currunt(props: LucideProps) {
  return (
    <svg
...
export function HexContainer({ id, children }: HexContainerProps) {
  return (
    <>
      <defs>
        ...
        <filter
          ...
          height="140%"
        >
          <feDropShadow dx="0" dy="4" stdDeviation="4" floodOpacity=".25" />
        </filter>
      </defs>
